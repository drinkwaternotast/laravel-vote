    	...
    	<div class="pair__list">
                ...
                <div class="pair__time">END TIME: {{ battle.end_at }}</div>
                    <div class="pair__box">
                        ...
                        <div class="caption">
                            ...
                            <button v-if="!(status === 'photo_history' || status === 'user_history')"
                                    class="square_btn__good"
                                    type="button"
            ...
            <div class="pair__rules_wrapper" v-if="battleList[0]">
                <div class="pair__rules">
                    <p><b>Tips</b></p>
                    <p><i class="fa fa-heart fa-fw"></i>Let's vote with the Good button!</p>
                    <p class="pair__rules_jp"><i class="fa fa-heart-o fa-fw"></i>あなたが良いと思った写真にGoodボタンを押しましょう</p>
                </div>
                <div class="pair__rules">
                    <p><b>Rules</b></p>
                    <p><i class="fa fa-heart fa-fw"></i>The fight will end in 48 hours.</p>
                    <p><i class="fa fa-heart fa-fw"></i>You can vote any photos except photos posted by you.</p>
                    <p><i class="fa fa-heart fa-fw"></i>If you ranked in the rankings, your photo may be treated as the main gallary of this site!!</p>
                    <p class="pair__rules_jp"><i class="fa fa-heart-o fa-fw"></i>バトルは開始から48時間で終了します。</p>
                    <p class="pair__rules_jp"><i class="fa fa-heart-o fa-fw"></i>自分の写真には投票することが出来ません。</p>
                    <p class="pair__rules_jp"><i class="fa fa-heart-o fa-fw"></i>もしあなたのいずれかの写真が多くの票を得た場合、ランキングに掲載され、このサイトのTOPを飾ることになるでしょう。</p>
                </div>
            </div>
...
export default {
    ...
    data() {
        return {
            battleList : [],
            error: {},
            initURL: `/api/user/current/battles/`,
            activeURL: null,
            namedRoute: 'currentBattles',
            status: 'battle',
            title: 'Battle',
            loading: true,
            counter: 0,
